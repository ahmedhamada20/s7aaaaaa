...
class CustomerController extends Controller
{
    protected $data = [
        'folderMain' => 'admin.',
        'folderBlade' => 'customer',
        'model' => 'App\Models\User',
        'route' => 'admins/customer',
    ];
    ...
    {
        $data = [
            'data' => $this->data['model']::with(['photo'])->whereType('customer')
    ...
    public function customer_remove_image(Request $request)
    {
        $photo = Photo::findorfail($request->photo_id);
        if (File::exists('admin/pictures/customer/' . $request->data_id . '/' . $photo->Filename)) {
