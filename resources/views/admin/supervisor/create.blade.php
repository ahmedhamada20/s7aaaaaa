...
@section('content')
    <h1 class="h3 mb-4 text-gray-800">Add new supervisor</h1>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary">Add new supervisor</h4>
        </div>
        <div class="card-body">
            <form action="{{route('admin.supervisor.store')}}" method="post" autocomplete="off"
