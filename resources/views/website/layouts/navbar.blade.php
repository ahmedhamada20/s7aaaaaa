                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @else
                        <li class="nav-item"><a class="nav-link"> <i
                                    class="fas fa-user me-1 text-gray fw-normal"></i>{{Auth::user()->full_name}}</a></li>


                        <li class="nav-item"><a class="nav-link" href="{{ route('logout') }}" onclick="event.preventDefault();  document.getElementById('logout-form').submit()"> <i class="fas fa-user me-1 text-gray fw-normal"></i> {{ __('Logout') }}</a></li>
