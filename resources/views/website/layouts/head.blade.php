...
<!-- gLightbox gallery-->
<link rel="stylesheet" href="{{asset('website/vendor/glightbox/css/glightbox.min.css')}}">
<!-- Range slider-->
<link rel="stylesheet" href="{{asset('website/vendor/nouislider/nouislider.min.css')}}">
<!-- Choices CSS-->
<link rel="stylesheet" href="{{asset('website/vendor/choices.js/public/assets/styles/choices.min.css')}}">
<!-- Swiper slider-->
